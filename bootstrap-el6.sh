...
# Install st2
cat >/etc/yum.repos.d/bintray-stackstorm-el6_staging-unstable.repo <<EOL
[bintray-stackstorm-el6_staging-unstable]
name=bintray-stackstorm-el6_staging-unstable
baseurl=https://dl.bintray.com/stackstorm/el6_staging/unstable
gpgcheck=0
enabled=1
EOL
cat >/etc/yum.repos.d/bintray-stackstorm-el6_staging-stable.repo <<EOL
[bintray-stackstorm-el6_staging-stable]
name=bintray-stackstorm-el6_staging-stable
baseurl=https://dl.bintray.com/stackstorm/el6_staging/stable
gpgcheck=0
enabled=1
EOL
yum install -y st2python st2bundle st2web mistral st2mistral
